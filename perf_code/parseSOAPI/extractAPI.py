...
if __name__ == "__main__":
    save_csv_path = 'D:\\work\\performance\\github_issues\\issues_desc\\extract_api\\issues_extract.csv'

    codesList=[]
    with open('D:\\work\\performance\\github_issues\\issues_desc\\desc_20_0102\\issues.csv', 'r', encoding='gb18030') as f:
        reader = csv.reader(f)
        for row in reader:
