...
def filter_id(commit, desc, file_path, sig, commit_index, line_ids):
    ...
    for index in range(commit_index, len(commit)):
        commit_id = commit.loc[index]['id']
        # if commit_id != '474d013a3b38c5909a7381cfa0cc2c8203807cfa':
        #         #     continue
        diff = commit.loc[index]['diff']
...
if __name__ == '__main__':
    path = 'D:\\MyDocument\\performance\\git_log\\auto_evol_0327\\docstring_format_desc12.csv'
    clone_path = 'D:\\MyDocument\\performance\\clone'
    save_path = 'D:\\MyDocument\\performance\\git_log\\auto_evol_0327\\auto_evol\\docstring_evol16.csv'
