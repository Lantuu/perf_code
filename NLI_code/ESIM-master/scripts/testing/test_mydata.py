...
if __name__ == "__main__":
 ...
 the MNLI matched and mismatched test sets')
    parser.add_argument('--checkpoint', default='D:/workspace/pychram/Bert2/GLUE/glue_data/MyData/NLI_Data/esmi_data/allDataset_c/model/best.pth.tar',
                        help="Path to a checkpoint with a pretrained model")
    parser.add_argument('--config', default='../../config/testing/mydata_testing.json',
