...
if __name__ == "__main__":
 ...
 some dataset")
    parser.add_argument("--test_data", default="D:\\workspace\\pychram\\Bert2\\GLUE\\glue_data\\MyData\\NLI_Data\\esmi_data\\train_esmi\\dataset\\test_data.pkl",
                        help="Path to a file containing preprocessed test data")
    parser.add_argument("--checkpoint", default="D:\\workspace\\pychram\\Bert2\\GLUE\\glue_data\\MyData\\NLI_Data\\esmi_data\\train_esmi\\model\\best.pth.tar",
